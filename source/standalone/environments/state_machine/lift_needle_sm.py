...
.. code-block:: bash
    ...
    ${ORBIT_PATH}/orbit.sh -p source/standalone/environments/state_machine/lift_needle_sm.py --num_envs 1
...
def main():
    ...
    desired_orientation[:, 1] = 0.70711
    desired_orientation[:, 2] = -0.70711
    ...
    while simulation_app.is_running():
        ...
        with torch.inference_mode():
            ...
            tcp_rest_position -= 0.01
            tcp_rest_orientation = ee_frame_sensor.data.target_quat_w[..., 0, :].clone()
            # -- object frame
            object_data: RigidObjectData = env.unwrapped.scene["object"].data
            robot: RigidObject = env.scene["robot"]
            object_position = object_data.root_pos_w - env.unwrapped.scene.env_origins
            object_position_b, _ = subtract_frame_transforms(robot.data.root_state_w[:, :3], robot.data.root_state_w[:, 3:7], object_position)
            # -- target object frame
